...
public class Inflector {
    ...
    protected void initialize() {
        ...
        inflect.addIrregular("olive", "olives");
        inflect.addIrregular("clove", "cloves");

        inflect.addUncountable("equipment", "information", "rice", "money", "species", "series", "fish", "sheep", "pasta", "capers", "focaccia", "polenta");
    }
